...
public class HelpRequestIT {
  ...
  public void an_admin_user_can_post_a_new_help_request() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/helprequest/post?requesterEmail=integration@ucsb.edu&teamId=02&tableOrBreakoutRoom=02&requestTime=2025-11-10T16:17:00&explanation=new_integration&solved=false")
                    .with(csrf()))
