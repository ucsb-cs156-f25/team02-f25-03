...
describe("UCSBOrganizationTable tests", () => {
  ...
  const expectedHeaders = ["orgCode", "Organization Translation Short", "Organization Translation", "Inactive"];
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    ).toHaveTextContent("Game Dev Club");

    expect(
      screen.getByTestId(`${testId}-cell-row-1-col-orgTranslation`),
    ).toHaveTextContent("Game Development Club");
