...
describe("UCSBDiningCommonsMenuItem tests", () => {
  ...
  test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
    ...
    fireEvent.change(diningCommonsCodeField, { target: { value: "test" } });
    fireEvent.change(nameField, { target: { value: "Eggs" } });
    fireEvent.change(stationField, { target: { value: "GSL" } });
    ...
    expect(mockToast).toBeCalledWith(
      "New ucsbDiningCommonsMenuItem Created - id: 17 name: Eggs",
    );
